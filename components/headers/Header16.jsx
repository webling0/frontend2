...
export default function Header16() {
  ...
  return (
    <header
      id="header"
      className="header-default header-absolute header-fullwidth-2 header-white header-style-7"
    >
      <div className="row wrapper-header align-items-center">
        ...
        <div className="col-xl-3 col-md-4 col-3">
          <div className="d-flex justify-content-end align-items-center gap-16 gap-xl-24">
            <ul className="nav-icon d-flex justify-content-end align-items-center">
              <li className="nav-search">
                <SearchTrigger />
              </li>
            </ul>
            <span className="br-line type-vertical d-none d-sm-block bg-white opacity-10" />
            <ul className="nav-icon d-flex justify-content-end align-items-center">
